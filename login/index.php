...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_button']) && isset($_POST['password']) && isset($_POST['email'])) {
    $password = $_POST['password'];
    $email = $_POST['email'];

    if (empty($email) || empty($password)) {
        $_SESSION['badAlert'] = "Email and password cannot be empty!";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            $_SESSION['goodAlert'] = "Logged in successfully!";
            header("Location: ..\home\index.php");
            exit();
        } else {
            $_SESSION['badAlert'] = "Invalid password!";
            header("Location: ..\login\index.php");
            exit();
        }
    } else {
        $_SESSION['badAlert'] = "User not found!";
        header("Location: ..\login\index.php");
        exit();
    }
}
    ...
    <section class="container">
        ...
        <div class="component">
            <form action="" method="post" class="input_box">
                ...
                <a href="..\signup\index.php" class="mb">➤ Załóż konto</a><br><br>
